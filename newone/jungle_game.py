...
def v():   
    ...
    print("Now you are in the jungle.")
    print("You went too deep in the jungle.")
    ...
    if(a==1):
        ...
        if(b==1):
            ...
            print("And he offer you some food.")
            print("And he shows the way to out.")
            ...
            if(f==1):
                ...
                print("You didnt trust him and choose anther way.")
                print("Soon you found a cave.")
        ...
        print("You hear a noice.")
        print("You want to follow that voice-press1-to follow,press2- to ignore")
        c=int(input("enter a value"))
        if(c==1):
            print("You found a dead man with gun.")
            print("You pick that gun and found some food and ammo in his bag.")
            print("Soon you hear a tiger roar.climb a tree-press1/ run-press2/3 for Quit")
            e=int(input("1/2/3="))
            if(e==1):
            ...
            print("You jump in thr river and you cross the river.")
            print("After some time you feel so weak and dizzyness soon you found leeches in your body.")  
